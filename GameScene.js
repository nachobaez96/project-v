...
class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.physics.add.collider(
      this.ball.body,
      this.player1.body,
      () => this.player1.handleBallCollision(this.ball.body),
      null,
      this
    );
    this.physics.add.collider(
      this.ball.body,
      this.player2.body,
      () => this.player2.handleBallCollision(this.ball.body),
      null,
      this
    );
    ...
    this.player1ScoreText = this.add.text(16, 16, "Player 1: 0", {
      fontSize: "32px",
      fill: "#000",
    });
    this.player2ScoreText = this.add.text(1200, 16, "Player 2: 0", {
      fontSize: "32px",
      fill: "#000",
    });
  }
